...
// WithLabels sets the labels in the service metadata
func WithLabels(s *serving.Service, labels map[string]string) {
	s.ObjectMeta.Labels = labels
}

// WithAnnotations sets the annotations in the service metadata
func WithAnnotations(s *serving.Service, annotations map[string]string) {
